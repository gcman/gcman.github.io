...
$endif$
\usepackage{xcolor}
\definecolor{MidnightBlue}{rgb}{0.1, 0.1, 0.5}
\usepackage{hyperref}
\hypersetup{
colorlinks=true,
linkcolor=Maroon,
...
$endif$
$endif$
\emph{This document originally appeared as a blog post on my website. Find it at} \texttt{\href{http://gautammanohar.com/$slug$}{gautammanohar.com/$slug$}}.
