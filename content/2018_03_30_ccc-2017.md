...
![**Figure 1.** The incomplete Lewis structure of sulfur dioxide.](https://gautammanohar.com/figures/so2-incomplete.png){ width=20% }
...
![**Figure 3.** A resonance form of sulfur dioxide with no formal charges.](https://gautammanohar.com/figures/so2-expanded-octet.png){ width=20% }
...
![**Figure 4.** Reagants Q, propanoyl chloride, and R, $\ce{AlCl3}$ react with benzene in a Friedel-Crafts acylation to form intermediate S.](https://gautammanohar.com/figures/2017-synth-1.png){ width=60% }
...
![**Figure 5.** Catalyzed by aluminum chloride, chlorine gas substitutes to form the given intermediate V.](https://gautammanohar.com/figures/2017-synth-2.png){ width=20% }
...
![**Figure 6.** Bromination yields intermediate W.](https://gautammanohar.com/figures/intermediate-W.png){ width=25% }
...
![**Figure 7.** Addition of tert-butylamine, reagant X, forms intermediate Y, which gives bupropion after treatment with reagant Z, hydrochloric acid.](https://gautammanohar.com/figures/2017-synth-3.png){ width=60% }
...
![**Figure 8.** The structures of the products from the five sets of reagants.](https://gautammanohar.com/figures/2017-synth-4.png){ width=70% }
...
\begin{equation}
	n_\ce{T} = 0.1002 \cdot 0.03207 = 3.21341 \times 10^{-3}.
\end{equation}
From the previous part, we know the moles of copper (II) are half the moles of thiosulfate, so
\begin{equation}
	n_\ce{Cu} = \frac{n_\ce{T}}{2} = \frac{3.21341 \times 10^{-3}}{2} = 1.60671 \times 10^{-3}.
\end{equation}
We then divide by the volume of copper (II) solution
\begin{equation}
	C_\ce{Cu} = \frac{n_\ce{Cu}}{V_\ce{Cu}} = \frac{1.60671 \times 10^{-3}}{0.050000} = 0.032134
\end{equation}
